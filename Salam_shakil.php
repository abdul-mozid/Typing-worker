...
<div id="total_right_sidebar">
	  ...
	  <div id="total_left_sidebar">
		...
		<!--End of Left Sidebar-->
		<div id="header_body">
		<div id="header_body_text"> Founder &amp; director </div>
		</div>
		<div id="body">
		 <div align="center"><div class="sakil"><img src="images/new_pic/sakil.jpg" width="280" height="350" /></div>
		 </div>
		  <hr />
		  <h5>
		    <p><strong><u>Founder & Director:</u></strong></p>
		    <strong><p>M.A. Salam Shakil, M.A. (N.U.)</p>
			...
			<p>Email: <a href="mailto:shakil@computer4u.com">shakil@computer4u.com</a></p>
			</strong>		  </h5>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
	      <p>&nbsp;</p>
